job "spring2" {
  ...
  group "spring2" {
    ...
    task "webapp2" {
        ...
        artifact {
            source = "http://nyc3.digitaloceanspaces.com/psmarsel/spring-core.jar"
        }
        ...
        config {
            command = "java"
            args = ["-Xmx2048m", "-Xms1024m","-Djava.security.egd=file:/dev/urandom","-jar","local/spring-core.jar"]
        }

        service {
          tags = ["webapp-spring-core"]
          port = "http"
          // check {
